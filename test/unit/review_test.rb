...
class ReviewTest < ActiveSupport::TestCase
  ...
  context "Saving a new review" do
    ...
    context "with valid info" do
      should "be persist the review" do
        review = Review.new(:wine => wines(:primus), :body => "This is an excellent wine.")
